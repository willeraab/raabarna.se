...
export const services: Service[] = [
  {
    ...
    description: 'Expert strategic planning services for all of life\'s major decisions, from corporate strategy to thermostat settings.',
  },
  {
    ...
    description: 'Comprehensive operational support to keep your household running smoothly, from finding lost items to optimizing evening routines.',
  },
  {
